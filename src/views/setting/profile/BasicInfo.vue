<template>
  <a-card title="basic information" bordered class="gradient-card">
    <div class="body">
      <section>
      ...
      <footer>
        <a-descriptions :column="4" size="large">
          <a-descriptions-item :span="4">
            <template #label> <icon-user /><span style="margin-left: 5px">username</span></template>
            {{ userInfo.username }}
          ...
          <a-descriptions-item :span="4">
            <template #label> <icon-phone /><span style="margin-left: 5px">phone</span></template>
            {{ userInfo.phone || 'no phone' }}
          </a-descriptions-item>


          <a-descriptions-item :span="4">
            <template #label> <icon-email /><span style="margin-left: 5px">email</span></template>
            {{ userInfo.email || 'no email' }}
          </a-descriptions-item>

          <a-descriptions-item :span="4">
            <template #label> <icon-mind-mapping /><span style="margin-left: 5px">department</span></template>
            {{ userInfo.deptName }}
          </a-descriptions-item>

          <a-descriptions-item :span="4">
            <template #label> <icon-user-group /><span style="margin-left: 5px">role</span></template>
            {{ userInfo.roles.join('，') }}
          </a-descriptions-item>
    ...
    <div class="footer">registered on {{ userInfo.registrationDate }}</div>
  </a-card>


  <a-modal v-model:visible="visible" title="upload avatar" :width="width >= 400 ? 400 : '100%'" :footer="false" draggable @close="reset">
    <a-row>
    ...
    <div style="text-align: center; padding-top: 30px">
      <a-space>
        <a-button type="primary" @click="handleUpload">confirm</a-button>
        <a-button @click="reset">cancel</a-button>
      </a-space>
