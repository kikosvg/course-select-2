<template>
  <div class="gi_table_page">
    ...
    <a-tabs v-model:active-key="activeKey" type="card-gutter" size="large" @change="change">
      <a-tab-pane key="1">
        <template #title><icon-settings /> basic configuration</template>
      </a-tab-pane>
      <a-tab-pane key="2">
        <template #title><icon-safe /> security configuration</template>

      </a-tab-pane>
      <a-tab-pane key="3">
        <template #title><icon-email /> email configuration</template>
      </a-tab-pane>
      <a-tab-pane key="4">

        <template #title><icon-lock /> login configuration</template>
      </a-tab-pane>
    </a-tabs>
