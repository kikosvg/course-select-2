    ...
    >
      ...
      <a-form-item class="input-item" field="SITE_DESCRIPTION" :label="siteConfig.SITE_DESCRIPTION.name">
        <a-textarea
          ...
          class="input-width"
          placeholder="please enter the system description"
          :auto-size="{ minRows: 1, maxRows: 3 }"
        />
      </a-form-item>

      <a-form-item class="input-item" field="SITE_COPYRIGHT" :label="siteConfig.SITE_COPYRIGHT.name">
        <a-input v-model.trim="form.SITE_COPYRIGHT" class="input-width" placeholder="please enter the copyright information" />
      </a-form-item>

      <a-form-item field="SITE_BEIAN" :label="siteConfig.SITE_BEIAN.name">
        <a-input v-model.trim="form.SITE_BEIAN" class="input-width" placeholder="please enter the beian number" :max-length="30" show-word-limit />
      </a-form-item>
...
const rules: FormInstance['rules'] = {
  SITE_TITLE: [{ required: true, message: 'please enter the system title' }],
  SITE_DESCRIPTION: [{ required: true, message: 'please enter the system description' }],
  SITE_COPYRIGHT: [{ required: true, message: 'please enter the copyright information' }],
}
...
const onResetValue = () => {
  Modal.warning({
    title: 'warning',
    content: 'are you sure to restore the basic configuration to the default value?',
    hideCancel: false,
    maskClosable: false,
