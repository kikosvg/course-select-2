...
const rules: FormInstance['rules'] = {
  MAIL_HOST: [{ required: true, message: 'please enter the value' }],
  MAIL_PORT: [{ required: true, message: 'please enter the value' }],
  MAIL_USERNAME: [{ required: true, message: 'please enter the value' }],
  MAIL_PASSWORD: [{ required: true, message: 'please enter the value' }],

  MAIL_SSL_PORT: [{ required: true, message: 'please enter the value' }],
...
const onResetValue = () => {
  Modal.warning({
    title: 'warning',
    content: 'are you sure to restore the email configuration to the default value?',
    hideCancel: false,
    maskClosable: false,
