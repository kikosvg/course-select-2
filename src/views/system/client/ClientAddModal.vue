...
const title = computed(() => (isUpdate.value ? 'modify client' : 'add client'))
...
const columns: Columns = reactive([
  {
    ...
    field: 'clientKey',
    type: 'input',
    rules: [{ required: true, message: 'please enter the client key' }],
    span: 2,
    disabled: () => {
  ...
  },
  {
    ...
    rules: [{ required: true, message: 'please select the authentication type' }],
  },
  ...
  {
    label: () => (
      <a-tooltip content="-1 permenantly not frozen">
    ...
    props: {
      placeholder: 'please enter the Token active timeout',
    },
    rules: [{ required: true, message: 'please enter the Token active timeout' }],

  },
  {
    label: () => (
      <a-tooltip content="-1 permenantly not expired">
        Token expiration
        <icon-info-circle-fill />
      </a-tooltip>
    ),
    ...
    props: {
      placeholder: 'please enter the Token expiration',
    },
    rules: [{ required: true, message: 'please enter the Token expiration' }],
