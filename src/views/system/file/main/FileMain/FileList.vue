  ...
  <div class="file-list">
    ...
    >
      <template #columns>
        ...
        <a-table-column title="size" data-index="size" :width="150">
          <template #cell="{ record }">{{ formatFileSize(record.size) }}</template>
        </a-table-column>

        <a-table-column title="storage name" data-index="storageName" :width="200" />
        <a-table-column title="update time" data-index="updateTime" :width="200" />
        <a-table-column title="action" :width="120" align="center">
          <template #cell="{ record }">
