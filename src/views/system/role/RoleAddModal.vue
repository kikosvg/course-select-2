<template>
  ...
  >
    <a-steps :current="current" class="mb-15" @change="onChangeCurrent">
      <a-step>basic information</a-step>
      <a-step>function permission</a-step>
      <a-step>data permission</a-step>
    </a-steps>
    ...
    <a-form ref="formRef" :model="form" :rules="rules" size="large" auto-label-width>
      <fieldset v-show="current === 1">
        ...
        <a-form-item label="code" field="code">
          ...
          <a-input v-model.trim="form.code" placeholder="please enter the code" />
        </a-form-item>
    ...
    <template #footer>
      <a-space size="large">
        ...
        <a-button v-if="current === 3" type="primary" @click="onClickOk">confirm</a-button>
      </a-space>
    </template>
