  ...
  <div class="error-page">
    <section class="error__container">
      ...
      <div class="error__tip">
        <div class="error__tip--a">sorry!</div>
        <div class="error__tip--b">the page you are looking for does not exist...</div>
        <div class="error__tip--c">please check if the address you entered is correct, or click the button below to return to the homepage</div>
        <a-button type="primary" shape="round" size="large" @click="back">return to homepage</a-button>
      </div>
    </section>
  </div>
</template>
