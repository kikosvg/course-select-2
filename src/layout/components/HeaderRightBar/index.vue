<template>
  <a-row justify="end" align="center">
    <a-space size="medium">
      <!-- 项目配置 -->
      <a-tooltip content="project configuration" position="bottom">
      ...
      <!-- 全屏切换组件 -->
      <a-tooltip v-if="!['xs', 'sm'].includes(breakpoint)" content="fullscreen switch" position="bottom">
      ...
      <!-- 暗黑模式切换 -->
      <a-tooltip content="theme switch" position="bottom">
        <ToggleDark />
      </a-tooltip>
